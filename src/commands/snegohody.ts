...
А пока подписывайтесь на наш канал с самыми выгодными вариантами <b>Снегоходов:</b>

<b>${TG_CHANNEL_SNEGOHODY_URL}</b>
`,
      {
        reply_markup: new InlineKeyboard().url('📢  ПОДПИСАТЬСЯ  📢', TG_CHANNEL_SNEGOHODY_URL),
        parse_mode: 'HTML'
      }
    );
  })
