...
📱 Мы уже собрали каталог выгодных предложений по вашему запросу. Чтобы получить его, нажмите на кнопку ниже.
`;
...
А пока подписывайтесь на наш канал с самыми выгодными вариантами <b>Квадроциклов:</b>

<b>${TG_CHANNEL_KVADROCIKLY_URL}</b>
`,
      {
        reply_markup: new InlineKeyboard().url('📢  ПОДПИСАТЬСЯ  📢', TG_CHANNEL_KVADROCIKLY_URL),
        parse_mode: 'HTML'
      }
    );
  })
